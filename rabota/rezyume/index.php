...
// Получение услуг
const MY_HL_BLOCK_ID_USLUGI = 17;
...
$arGrafic = userFieldEnum(185);
//$arCandidat = userFieldEnum(159);

$rsData = CUserTypeEntity::GetList( array(), array("ENTITY_ID" => 'HLBLOCK_11') );
$arEnum=[];
...
foreach ($arEnum as $key => $enumId){
    if($enumId['SETTINGS']['DISPLAY'] == 'CHECKBOX'){
        $rsEnum = CUserFieldEnum::GetList(array(), array("USER_FIELD_ID" => $enumId['ID']));
        while ($ob = $rsEnum->fetch()) {
            $arEnum[$key]['VALUE'][] = $ob;
        ...
        <section class="data data--services data--work">
            <div class="container">
                ...
                <div class="data__offers">
                    <?echo ($entity_data_class_uslugi::getCount());?> предложений
                </div>

                <ul class="data__categories">
                    <li class="data__categories-item data__categories-item--long fitted">
                        <a href="/rabota" class="data__categories-label">
            ...
            <div class="container">
                <div class="announcements__top">
                    ...
                    <div class="announcements__select">
                        ...
                        <input class="select-input" type="text" id="resume_select_date">
                    ...
                    <div class="announcements__select">
                        ...
                        <input class="select-input" type="text" id="resume_select_price">
                        <ul class="announcements__select-list">
                            <li data-value="" class="announcements__select-list-item active">
                                По умолчанию
                            </li>
                ...
                <div class="announcements__inner">
                    ...
                    <form class="filter announcements__filter-properity filter-resume">
                        ...
                        <button class="filter__submit" type="submit">
                            Показать <span class="filter__submit-count"><? echo(count($arUslugi)); ?></span> объявлений
                        </button>
