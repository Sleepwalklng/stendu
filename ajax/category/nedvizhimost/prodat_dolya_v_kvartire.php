                ...
                <div class="announcement-content">
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-content__block-wrap grid">
                            ...
                            <div class="col_33">
                                <div class="label">
                                    <div class="announcement-label__title">Вид:</div>
                                    <select name="UF_CHOICE_APART" id="">
                            ...
                            <div class="col_33">
                                <label class="label-checkbox narrow">
                                    <input name="UF_PENTHOUSE" type="checkbox" class="visually-hidden" checked>
                                    <span></span>
                                    <div>Пентхаус</div>
                                </label>
                            </div>
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-content__block-wrap grid">
                            <div class="col_33">
                                <label>
                                    <div class="announcement-label__title">Жилая площадь</div>
                                    <input type="text" name="UF_LIVING_AREA">
                                </label>
                            </div>
                            ...
                            <div class="col_50">
                                <label>
                                    <div class="announcement-label__title">Площадь комнат</div>
                                    <input name="UF_ROOMS_AREA" type="text"
