                ...
                <div class="announcement-content">
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-content__block-wrap grid">
                            ...
                            <div class="col_33">
                                <label>
                                    <div class="announcement-label__title">Номер налоговой</div>
                                    <input type="text" name="UF_NTAX">
                                </label>
                            </div>

                            <div class="col_33">
                                <div class="label">
                                    <div class="announcement-label__title">Тип помещения</div>
                                    <select name="UF_ROOM_TYPE" id="">
                                        <option value="Street retail">Street retail</option>
                                        <option value="В торговом комплексе">В торговом комплексе</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-chapter">
                            <div class="grid">
                                ...
                                <div class="col_33">
                                    <div class="label">
                                        <div class="announcement-label__title">Часы работы</div>
                                        <input type="text" name="UF_HOURS">
                                    </div>
                                </div>

                                <div class="col_33">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_ALLDAY">
                                        <span></span>
                                ...
                                <div class="col_33">
                                    <div class="label">
                                        <div class="announcement-label__title">Дни недели</div>
                                        <select name="UF_WEEK_DAYS" id="">
                        ...
                        <div class="announcement-chapter">
                            ...
                            <div class="grid">
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_AQUAPARK">
                                        <span></span>
                                        <div>Аквапарк</div>
                                    </label>
                                </div>
                        ...
                        <div class="announcement-chapter">
                            ...
                            <div class="grid">
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_BABY_CITY">
                                        <span></span>
                                        <div>Беби-ситинг</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_PLAY_ROOM">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_BOWLING">
                                        <span></span>
                                        <div>Боулинг</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_ICE_RINK">
                                        <span></span>
                                        <div>Каток</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_FOOD_COURT">
                                        <span></span>
                                        <div>Фуд-корт</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_SLOT_MACHINES">
                                        <span></span>
                                        <div>Игровые автоматы</div>
                                    </label>
                                </div>
