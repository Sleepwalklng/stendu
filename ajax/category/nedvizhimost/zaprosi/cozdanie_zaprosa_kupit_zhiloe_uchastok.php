                ...
                <div class="announcement-content">
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Статус участка</div>
                            <div class="grid">
                                <div class="col_25">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Иное</div>
                            <label>
                                <input name="UF_PLOT_STATUS_OTHER" type="text">
                            </label>
