                ...
                <div class="announcement-content">
                        ...
                        <div class="announcement-content__category-block">
                            <div class="announcement-content__category-name">
                                ...
                                <div class="announcement-content__category-text">
                                    ...
                                    <div class="announcement-content__category-description">Доля в квартире</div>
                                </div>
                            </div>
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Размер доли</div>

                            <div class="range ">
                                <label>
                                    <input name="UF_SHARE_SIZE_OT" type="number" placeholder="от">
                                </label>
                                <label>
                                    <input name="UF_SHARE_SIZE_DO" type="number" placeholder="до">
                                </label>
                            </div>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Тип квартиры
                            </div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_PENTHOUSE" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Пентхаус</div>
                                    </label>
                                </div>
                    ...
                    <div class="announcement-content__block announcement-content__deal">
                        ...
                        <? if ($_REQUEST['agent'] == 82): ?>
                            <div class="announcement-chapter announcement-chapter--without-divider">
                                <div class="grid">
                                    <div class="col_66">
                                        <div class="announcement-chapter__title announcement-chapter__title--bold">Бонус
                                            к агенту
                                        </div>
                                        <div class="grid">
                                            <div class="col_33">
                                    ...
                                    <div class="col_33">
                                        ...
                                        <div class="range">
                                            <label>
                                                <input name="UF_AGENT_BONUS_VALUE_OT" type="number" placeholder="от">
                                            </label>
                                            <label>
                                                <input name="UF_AGENT_BONUS_VALUE_DO" type="number" placeholder="до">
                                            </label>
                                        </div>
                                    </div>
