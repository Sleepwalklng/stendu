                ...
                <div class="announcement-content">
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Снять</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_PART_HOUSE_Y" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Часть дома</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_PART_HOUSE_N" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Дом</div>
                                    </label>
                                </div>
...
Например, по их национальности или полу."></textarea>
                    ...
                    <div class="announcement-content__block announcement-content__deal">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="grid">
                                <div class="col_33">
                                    <div class="announcement-chapter__title announcement-chapter__title--bold">Цена за сутки, €</div>
                                    <div class="range">
                                        <label>
