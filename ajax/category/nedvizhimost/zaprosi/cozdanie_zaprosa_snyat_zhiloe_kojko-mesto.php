                ...
                <div class="announcement-content">
                        ...
                        <div class="announcement-content__category-block">
                            <div class="announcement-content__category-name">
                                ...
                                <div class="announcement-content__category-text">
                                    ...
                                    <div class="announcement-content__category-description">Койко-место</div>
                                </div>
                            </div>
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Количество комнат в аренду</div>

                            <div class="announcement-switch announcement-switch--separate">
                                <div class="announcement-switch__wrap">
                                    <label class="announcement-switch__item">
                                        <input type="radio" name="UF_ROOMS_FOR_SALE" checked value="1">
                                        <span>1</span>
                                    </label>
                                    <label class="announcement-switch__item">
                                        <input type="radio" name="UF_ROOMS_FOR_SALE">
                                        <span>2</span>
                                    </label>
                                    <label class="announcement-switch__item">
                                        <input type="radio" name="UF_ROOMS_FOR_SALE">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Количество спальных мест</div>

                            <div class="announcement-switch announcement-switch--separate">
                                <div class="announcement-switch__wrap">
                                    <label class="announcement-switch__item">
                                        <input type="radio" name="UF_SLEEPING_NUM" checked value="1">
                                        <span>1</span>
                                    </label>
                                    <label class="announcement-switch__item">
                                        <input type="radio" name="UF_SLEEPING_NUM">
                                        <span>2</span>
                                    </label>
                                    <label class="announcement-switch__item">
                                        <input type="radio" name="UF_SLEEPING_NUM">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Тип комнаты</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_TYPE_OF_ROOM" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Смежная и изолированная</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col_50">
                                            <div class="checkbox_group">
                                                <label class="label-checkbox label-checkbox--boxy">
                                                    <input name="UF_FLOOR_LEVEL_NOT_FIRST" type="checkbox" class="visually-hidden" >
                                                    <span></span>
                                                    <div>не первый</div>
                                                </label>
                                                <label class="label-checkbox label-checkbox--boxy">
                                                    <input name="UF_FLOOR_LEVEL_NOT_LAST" type="checkbox" class="visually-hidden">
                                                    <span></span>
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="grid">
                                <div class="col_33">
                                    <div class="announcement-chapter__title announcement-chapter__title--bold">Площадь комнаты, м²</div>

                                    <div class="range">
                                        <label>
                                            <input name="UF_ROOM_AREA_OT" type="number" placeholder="от">
                                        </label>
                                        <label>
                                            <input name="UF_ROOM_AREA_DO" type="number" placeholder="до">
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Удобства</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_KITCHEN">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_ROOMS_FURNITURE">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_FRIDGE">
                                        <span></span>
                                        <div>Холодильник</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_WASH">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_INTERNET">
                                        <span></span>
                                        <div>Интернет</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_TV">
                                        <span></span>
                                        <div>Телевизор</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_CONDITIONER">
                                        <span></span>
                                        <div>Кондиционер</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_DISHWASHER">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_HAVE_PHONE">
                                        <span></span>
                                        <div>Телефон</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_BATH">
                                        <span></span>
                                        <div>Ванна</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_SHOWER_ROOM">
                                        <span></span>
                                        <div>Душевая кабине</div>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Количество санузлов</div>
                            <div class="announcement-switch announcement-switch--separate">
                                <div class="announcement-switch__wrap">
                                    <label class="announcement-switch__item">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Состав съемщиков</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_WITH_CHILDREN" type="checkbox" class="visually-hidden infrastructure">
                                        <span></span>
                                        <div>С детьми</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_PETS" type="checkbox" class="visually-hidden infrastructure">
                                        <span></span>
                                        <div>С животными</div>
                                    </label>
                                </div>
...
Например, по их национальности или полу."></textarea>
                    ...
                    <div class="announcement-content__block announcement-content__deal">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="grid">
                                <div class="col_33">
                                    <div class="announcement-chapter__title announcement-chapter__title--bold">Арендная плата, €/мес</div>
                                    <div class="range">
                                        <label>
                                ...
                                <div class="col_33">
                                    <div class="announcement-chapter__title announcement-chapter__title--bold">Залог, €</div>
                                    <div class="range">
                                        <label>
                                            <input name="UF_DEPOSIT_OT" type="number" placeholder="от">
                                        </label>
                                        <label>
                                            <input name="UF_DEPOSIT_DO" type="number" placeholder="до">
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_COM_PAY_N" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Не включены</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_COM_PAY_Y" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Забронированное значение</div>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Коммунальные платежи, €/мес</div>
                            <div class="range">
                                <label>
                                    <input name="UF_COM_PAY_OT" type="number" placeholder="от">
                                </label>
                                <label>
                                    <input name="UF_COM_PAY_DO" type="number" placeholder="до">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="grid">
                                ...
                                <div class="col_50">
                                    <div class="announcement-chapter__title announcement-chapter__title--bold">Срок аренды, месяц</div>
                                    <div class="announcement-switch announcement-switch--separate">
                                        <div class="announcement-switch__wrap">
                                            <label class="announcement-switch__item">
                                                <input type="radio" name="UF_RENT_PERIOD" checked value="1">
                                                <span>1</span>
                                            </label>
                                            <label class="announcement-switch__item">
                                                <input type="radio" name="UF_RENT_PERIOD">
                                                <span>2</span>
                                            </label>
                                            <label class="announcement-switch__item">
                                                <input type="radio" name="UF_RENT_PERIOD">
