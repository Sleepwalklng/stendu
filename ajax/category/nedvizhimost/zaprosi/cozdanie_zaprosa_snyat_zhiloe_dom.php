                ...
                <div class="announcement-content">
                        ...
                        <div class="announcement-content__category-block">
                            <div class="announcement-content__category-name">
                                ...
                                <div class="announcement-content__category-text">
                                    ...
                                    <div class="announcement-content__category-description">Дом</div>
                                </div>
                            </div>
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Этажей в доме</div>
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="grid">
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_BATHROOM_IN">
                                        <span></span>
                                        <div>Санузел в доме</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_BATHROOM_OUT">
                                        <span></span>
                                        <div>Санузел на улице</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Отопление</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_HEATING" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Центральное газовое</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
