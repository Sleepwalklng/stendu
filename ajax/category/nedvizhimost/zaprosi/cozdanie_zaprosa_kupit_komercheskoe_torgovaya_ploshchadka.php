                ...
                <div class="announcement-content">
                        ...
                        <div class="announcement-content__category-block">
                            <div class="announcement-content__category-name">
                                ...
                                <div class="announcement-content__category-text">
                                    ...
                                    <div class="announcement-content__category-description">Торговая площадка</div>
                                </div>
                            </div>
                    ...
                    <div class="announcement-content__block announcement-content__apartment">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Тип помещения
                            </div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_ROOM_TYPE" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Street retail</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Возможное
                                назначение
                            </div>
                            <div class="grid">
                                <? foreach ($arr as $item): ?>
                            ...
                            <button type="button" class="announcement-chapter__title view_more">Показать еще</button>
                        </div>

                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Юридический
                                адрес
                            </div>
                            <div class="grid">
                                <div class="col_25">
                            ...
                            <div class="grid">
                                ...
                                <div class="col_33">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        ...
                                        <span></span>
                                        <div>Возможна аренда частями</div>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Витринные окна
                            </div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="grid">
                                <div class="col_33">
                                    ...
                                    <div class="announcement-chapter__title announcement-chapter__title--bold">Часы
                                        работы
                                    </div>

                                    <div class="range">
                                        <label>
                                            <input name="UF_HOURS_OT" type="number" placeholder="от">
                                        </label>
                                        <label>
                                            <input name="UF_HOURS_DO" type="number" placeholder="до">
                                        </label>
                                    </div>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_ALLDAY" type="checkbox" class="visually-hidden">
                                        <span></span>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            <div class="announcement-chapter__title announcement-chapter__title--bold">Дни недели</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input name="UF_WEEK_DAYS" type="checkbox" class="visually-hidden">
                                        <span></span>
                                        <div>Будни</div>
                                    </label>
                                </div>
                        ...
                        <div class="announcement-chapter announcement-chapter--without-divider">
                            ...
                            <div class="grid">
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_ATELIER">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure"
                                               name="UF_BABY_CITY">
                                        <span></span>
                                        <div>Беби-ситтинг</div>
                                    </label>
                                </div>
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_BOWLING">
                                        <span></span>
                                        <div>Боулинг</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_COMPLEX">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_CAFE">
                                        <span></span>
                                        <div>Кафе</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_BANK">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_PARK">
                                        <span></span>
                                        <div>Парк</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox label-checkbox--boxy">
                                        <input type="checkbox" class="visually-hidden infrastructure" name="UF_FITNESS">
                                        <span></span>
