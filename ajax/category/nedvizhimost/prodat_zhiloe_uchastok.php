                        ...
                        <div class="announcement-content__category-block">
                            <div class="announcement-content__category-name">
                                ...
                                <div class="announcement-content__category-text">
                                    ...
                                    <div class="announcement-content__category-description">Участок</div>
                                </div>
                            </div>
                            ...
                            <div class="col_33">
                                <div class="label">
                                    ...
                                    <select name="UF_GAS" id="">
                                        <option value="Нет">Нет</option>
                                        <option value="Магистральный в доме или на участке">Магистральный в доме или на
                                            участке
                                        </option>
                                        <option value="Магистральный по границе участка">Магистральный по границе
                                            участка
                                        </option>
