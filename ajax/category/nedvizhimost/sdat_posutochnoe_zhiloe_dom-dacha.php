                    ...
                    <div class="announcement-content__block-wrap grid">
                        ...
                        <div class="col_33">
                            <label class="label-checkbox narrow">
                                <input type="checkbox" class="visually-hidden" checked name="UF_PART_HOUSE">
                                <span></span>
                                <div>Сдается только часть дома</div>
                            </label>
                        </div>
...
Например, по их национальности или полу."></textarea>
                ...
                <div class="announcement-content__block announcement-content__deal">
                    ...
                    <div class="announcement-content__block-wrap grid">
                        <div class="col_50">
                            <label>
                                <div class="announcement-label__title">Цена за сутки</div>
