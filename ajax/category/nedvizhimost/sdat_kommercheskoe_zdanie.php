...
Например, по их национальности или полу."></textarea>
                    ...
                    <div class="announcement-content__block announcement-content__deal">
                        ...
                        <div class="announcement-content__block-wrap grid">
                            ...
                            <div class="col_50">
                                <div class="label">
                                    <div class="announcement-label__title">Ставка за м2</div>
                                    <input type="text" value="300" name="UF_RATE_PER_M2">
                            ...
                            <div class="col_50">
                                <div class="label">
                                    <div class="announcement-label__title">Период оплаты</div>
                                    <select name="UF_PAY_PERIOD" id="">
