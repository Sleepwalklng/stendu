            ...
            <div class="announcement-content">
                ...
                <div class="announcement-content__block announcement-content__apartment">
                    ...
                    <div class="announcement-content__block-wrap grid">
                        ...
                        <div class="col_33">
                            <div class="label">
                                <div class="announcement-label__title">Тип дома</div>
                                <select name="UF_TYPE_OF_HS" id="">
                                    <option value="Дом для постоянного проживания">Дом для постоянного проживания
                                    </option>
                        ...
                        <div class="col_33">
                            <div class="label">
                                ...
                                <select name="UF_PLOT_STATUS" id="plot-status">
                                    <option value="Фермерское хозяйство">Фермерское хозяйство</option>
                                    <option value="Садоводство">Садоводство</option>
                                    <option value="Личное подсобное хозяйство">Личное подсобное хозяйство</option>
                        ...
                        <div class="grid">
                            ...
                            <div class="col_33">
                                <div class="label">
                                    ...
                                    <select name="UF_GAS" id="">
                                        <option value="Нет">Нет</option>
                                        <option value="Магистральный в доме или на участке">Магистральный в доме или на участке</option>
                                        <option value="Магистральный по границе участка">Магистральный по границе участка</option>
                            ...
                            <div class="col_33">
                                <label class="label-checkbox narrow">
                                    <input name="UF_ELECTRICITY" type="checkbox" class="visually-hidden" checked>
                                    <span></span>
