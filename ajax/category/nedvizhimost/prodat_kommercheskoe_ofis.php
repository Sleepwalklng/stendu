                ...
                <div class="announcement-content">
                    ...
                    <div class="announcement-content__block">
                        ...
                        <div class="announcement-content__block-wrap grid">
                            ...
                            <div class="col_33">
                                <div class="label">
                                    ...
                                    <select name="UF_CONDITION" id="">
                                        <option value="Офисная отделка">Офисная отделка</option>
                                        ...
                                        <option value="Требуется косметический ремонт">Требуется косметический ремонт
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col_33">
                                <div class="label">
                                    <div class="announcement-label__title">Доступ</div>
                                    <select name="UF_ACCESS" id="">
                                        <option value="Свободный">Свободный</option>
                                        <option value="Пропускная система">Пропускная система</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="announcement-content__block">
                                ...
                                <div class="col_33">
                                    <div class="label">
                                        ...
                                        <select name="UF_BUILDING_TYPE" id="">
                                            ...
                                            <option value="Бизнес-квартал">Бизнес-квартал</option>
                                            <option value="Особняк">Особняк</option>
                                            <option value="Многофункциональный комплекс">Многофункциональный комплекс
                                            </option>
                                            <option value="Офисно-гостиничный комплекс">Офисно-гостиничный комплекс
                                            </option>
                                            <option value="Офисно-жилой комплекс">Офисно-жилой комплекс</option>
                                            <option value="Офсино-складской комплекс">Офсино-складской комплекс</option>
                                            <option value="Офисное здание">Офисное здание</option>
                                            <option value="Офисно-производственный комплекс">Офисно-производственный
                                                комплекс
                                            </option>
                                            ...
                                            <option value="Торгово-деловой комплекс">Торгово-деловой комплекс</option>
                                            <option value="Отдельно стоящее здание">Отдельно стоящее здание</option>
                                            <option value="Технопарк">Технопарк</option>
                                            <option value="Торгово-офисный комплекс">Торгово-офисный комплекс</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="announcement-chapter">
                            <div class="announcement-chapter__title">Инфраструктура</div>
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_PHARMACY">
                                        <span></span>
                                        <div>Аптека</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_ATELIER">
                                        <span></span>
                        ...
                        <div class="announcement-chapter">
                            ...
                            <div class="grid">
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_ATM">
                                        <span></span>
                                        <div>Банкомат</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_POOL">
                                        <span></span>
                                        <div>Бассейн</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_COMPLEX">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_CAFE">
                                        <span></span>
                                        <div>Кафе</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_MOVIE_THEATER">
                                        <span></span>
                                        <div>Кинотеатр</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_CONFERENCE_HALL">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_MED_CENTER">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_MINIMARKET">
                                        <span></span>
                                        <div>Минимаркет</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_WAREHOUSES">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_NOTARIAL">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_BANK">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_PARK">
                                        <span></span>
                                        <div>Парк</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_RESTAURANT">
                                        <span></span>
                                        <div>Ресторан</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_BEAUTY_SALOON">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_SUPERMARKET">
                                        <span></span>
                                        <div>Супермаркет</div>
                                    </label>
                                </div>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_TRADING_ZONE">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_FITNESS">
                                        <span></span>
                                ...
                                <div class="col_25">
                                    <label class="label-checkbox narrow">
                                        <input type="checkbox" class="visually-hidden" name="UF_FOTO_SALOON">
                                        <span></span>
                                        <div>Фотосалон</div>
                                    </label>
                                </div>
...
Например, по их национальности или полу."></textarea>
                    ...
                    <div class="announcement-content__block announcement-content__deal">
                        ...
                        <div class="announcement-content__block-wrap grid">
                            ...
                            <!--                        <div class="col_33">-->
                            <!--                            <div class="label">-->
                            <!--                                <div class="announcement-label__title">Валюта</div>-->
                            <!--                                <select name="" id="">-->
                            <!--                                    <option value="3">рубли</option>-->
                            <!--                                    <option value="2">рубли 2</option>-->
                            <!--                                    <option value="1">рубли 1</option>-->
                            <!--                                    <option value="4">рубли 4</option>-->
                            <!--                                </select>-->
                            <!--                            </div>-->
                            <!--                        </div>-->
