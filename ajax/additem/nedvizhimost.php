...
$arType = [
    ['UF_DEAL_TYPE' => 68,//Сдать посуточно
        'UF_TYPE' => [126],//квартира
        'array' => ['UF_ADDRESS', 'UF_NUMBER_OF_ROOMS', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_TOTAL_AREA', 'UF_PRICE', 'UF_DEPOSIT', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 68,//Сдать посуточно
        'UF_TYPE' => [127, 134],//комната
        'array' => ['UF_ADDRESS', 'UF_NUMBER_OF_ROOMS', 'UF_ROOMS_FOR_SALE', 'UF_ROOM_AREA', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_TOTAL_AREA', 'UF_PRICE', 'UF_DEPOSIT', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 68,//Сдать посуточно
        'UF_TYPE' => [129],//дом
        'array' => ['UF_ADDRESS', 'UF_HOUSE_SQUARE', 'UF_PLOT_SQUARE', 'UF_PRICE', 'UF_DEPOSIT', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 144,//жилая
        'UF_TYPE' => [126],//квартира
        'array' => ['UF_ADDRESS', 'UF_NUMBER_OF_ROOMS', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_TOTAL_AREA', 'UF_PRICE', 'UF_SALES_TYPE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 144,//жилая
        'UF_TYPE' => [127],//комната
        'array' => ['UF_ADDRESS', 'UF_NUMBER_OF_ROOMS', 'UF_ROOMS_FOR_SALE', 'UF_ROOM_AREA', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_TOTAL_AREA', 'UF_PRICE', 'UF_SALES_TYPE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 144,//жилая
        'UF_TYPE' => [128],//доля в квартире
        'array' => ['UF_ADDRESS', 'UF_NUMBER_OF_ROOMS', 'UF_SHARE_SIZE', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_TOTAL_AREA', 'UF_PRICE', 'UF_SALES_TYPE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 144,//жилая
        'UF_TYPE' => [129, 131],//дом,таунхаус
        'array' => ['UF_ADDRESS', 'UF_TYPE_OF_HS', 'UF_PLOT_STATUS', 'UF_HOUSE_SQUARE', 'UF_PLOT_SQUARE', 'UF_GAS', 'UF_PRICE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 144,//жилая
        'UF_TYPE' => [132],//часть дома
        'array' => ['UF_ADDRESS', 'UF_SHARE_SIZE', 'UF_PLOT_STATUS', 'UF_HOUSE_SQUARE', 'UF_PLOT_SQUARE', 'UF_GAS', 'UF_PRICE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 144,//жилая
        'UF_TYPE' => [133],//участок
        'array' => ['UF_ADDRESS', 'UF_PLOT_STATUS', 'UF_PLOT_SQUARE', 'UF_GAS', 'UF_PRICE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [135, 137, 138],//офис,производство,склад
        'array' => ['UF_ADDRESS', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_COM_SQUARE', 'UF_PRICE', 'UF_TAX', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [136],//здание
        'array' => ['UF_ADDRESS', 'UF_FLOOR_LEVEL_MAX', 'UF_COM_SQUARE', 'UF_PRICE', 'UF_TAX', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [139],//гараж
        'array' => ['UF_ADDRESS', 'UF_GARAGE_TYPE', 'UF_COM_SQUARE', 'UF_PRICE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [140],//готовый бизнес
        'array' => ['UF_ADDRESS', 'UF_BUSINESS_TYPE', 'UF_BUSINESS_CATEGORY', 'UF_MONTH_PROFIT', 'UF_COM_SQUARE', 'UF_PRICE', 'UF_TAX', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [141, 142],//помещение свободного назначения|торговая площадка
        'array' => ['UF_ADDRESS', 'UF_POSPURPOSE', 'UF_FLOOR_LEVEL', 'UF_FLOOR_LEVEL_MAX', 'UF_COM_SQUARE', 'UF_PRICE', 'UF_TAX', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 66,//Продать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [143],//коммерческая земля
        'array' => ['UF_ADDRESS', 'UF_PLOT_SQUARE', 'UF_PRICE', 'UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 144,//Жилая
        'UF_TYPE' => [126],//квартира
        'array' => ['UF_ADDRESS','UF_NUMBER_OF_ROOMS','UF_RENT_PERIOD','UF_PREPAY','UF_FLOOR_LEVEL','UF_FLOOR_LEVEL_MAX','UF_TOTAL_AREA','UF_PRICE','UF_COM_PAY','UF_COM_PAY','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 144,//Жилая
        'UF_TYPE' => [127,134],//комната/койко-место
        'array' => ['UF_ADDRESS','UF_PREPAY','UF_RENT_PERIOD','UF_COM_PAY','UF_COM_PAY','UF_NUMBER_OF_ROOMS','UF_ROOMS_FOR_SALE','UF_ROOM_AREA','UF_FLOOR_LEVEL','UF_FLOOR_LEVEL_MAX','UF_TOTAL_AREA','UF_PRICE','UF_SALES_TYPE','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 144,//Жилая
        'UF_TYPE' => [129,131],//дом,таунхаус
        'array' => ['UF_ADDRESS','UF_TYPE_OF_HS','UF_PREPAY','UF_RENT_PERIOD','UF_COM_PAY','UF_COM_PAY','UF_HOUSE_SQUARE','UF_PLOT_SQUARE','UF_PRICE','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 144,//Жилая
        'UF_TYPE' => [132],//часть дома
        'array' => ['UF_ADDRESS','UF_PART_RENT','UF_TYPE_OF_HS','UF_PREPAY','UF_COM_PAY','UF_COM_PAY','UF_HOUSE_SQUARE','UF_PLOT_SQUARE','UF_PRICE','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [135,137,138],//офис,производство,склад
        'array' => ['UF_ADDRESS','UF_FLOOR_LEVEL','UF_FLOOR_LEVEL_MAX','UF_COM_SQUARE','UF_PRICE','UF_COMMISSIONS_RENT','UF_COMMISSIONS_AGENT','UF_RENT_PERIOD','UF_PREPAY','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [136],//здание
        'array' => ['UF_ADDRESS','UF_FLOOR_LEVEL_MAX','UF_COM_SQUARE','UF_PRICE','UF_COMMISSIONS_RENT','UF_COMMISSIONS_AGENT','UF_RENT_PERIOD','UF_PREPAY','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [139],//гараж
        'array' => ['UF_ADDRESS','UF_GARAGE_TYPE','UF_COM_SQUARE','UF_PRICE','UF_COMMISSIONS_RENT','UF_RENT_PERIOD','UF_PREPAY','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [141,142],//помещение свободного назначения|торговая площадка
        'array' => ['UF_ADDRESS','UF_POSPURPOSE','UF_FLOOR_LEVEL','UF_FLOOR_LEVEL_MAX','UF_COM_SQUARE','UF_PRICE','UF_COMMISSIONS_RENT','UF_COMMISSIONS_AGENT','UF_RENT_PERIOD','UF_PREPAY','UF_OWNER_PHONE']
    ],
    ['UF_DEAL_TYPE' => 67,//Сдать
        'UF_TYPE_OF_RS' => 145,//Коммерческая
        'UF_TYPE' => [143],//коммерческая земля
        'array' => ['UF_ADDRESS','UF_PLOT_SQUARE','UF_PRICE','UF_COMMISSIONS_RENT','UF_COMMISSIONS_AGENT','UF_RENT_PERIOD','UF_PREPAY','UF_OWNER_PHONE']
    ],
...
function setProperty($oper, $id, $arr): object
{
...
function getPropertyRes($arrFields, $arrErrors, $arr): array
{
    $array = [];
    $arrEmpty = [];
    $res_json = [];
    ...
    if ($allElementsNotEmpty) {
        $result = setProperty($_REQUEST['oper'], $_REQUEST['id'], $arr);
        if ($result->isSuccess()) {
...
function getPropertyResult($dealType, $type, $typeOfRs, $arType, $arrErrors, $arr):array
{
    $json = [];
    foreach ($arType as $item) {
        if ($dealType == $item['UF_DEAL_TYPE']) {
            if ($typeOfRs) {
                if ($typeOfRs == $item['UF_TYPE_OF_RS']) {
                    if (in_array($type, $item['UF_TYPE'])) {
                        $json = getPropertyRes($item['array'], $arrErrors, $arr);
...
$json = getPropertyResult($_REQUEST['UF_DEAL_TYPE'],$_REQUEST['UF_TYPE'],$_REQUEST['UF_TYPE_OF_RS'],$arType,$arrErrors,$arr);
