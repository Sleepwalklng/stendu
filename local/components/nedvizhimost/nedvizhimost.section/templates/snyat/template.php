...
<main class="main main--hidden  ">
    ...
    <section class="map">
        ...
        <div class="container">
            ...
            <a class="map__btn" href="/<?=LANGUAGE_ID?>/nedvizhimost/map.php?type_deal=67&type_rent=На длительный срок">Объявления на карте</a>
        </div>
    </section>
            ...
            <div class="announcements__inner">
                    ...
                    <ul class="announcements__items">
                        <? foreach ($arRealEstate as $arItem): ?>
                            <li class="announcements__item cart <? if (in_array($arItem['ID'], $resultFav)) {
                                ...
                                <a href="/<?=LANGUAGE_ID?>/nedvizhimost/snyat/<?= $arItem['UF_SESSION_CODE'] ?>/">
                                    <div class="cart__top">
                ...
                <form class="filter announcements__filter-properity filter-real_estate">
                    ...
                    <ul class="filter__items">
                        ...
                        <li class="filter__item " id="filter__item_type_of_rs">
                            <div class="info__select">
