...
<main class="main main--hidden  ">
    <section class="data">
        <div class="container">
            <div class="data__title data__title--property title">
                <span class="data__title-categories"><?=RealEstateSection::getItemTranslate('Недвижимость',LANGUAGE_ID)?></span>

                <img class="data__title-img" src="<?= SITE_TEMPLATE_PATH ?>/images/date-title2.png"
                     alt="<?=RealEstateSection::getItemTranslate('Недвижимость',LANGUAGE_ID)?>">

                <span class="data__title-text"><?=RealEstateSection::getItemTranslate('в Риге',LANGUAGE_ID)?></span>
            </div>
            ...
            <div class="data__offers">
                <? echo(count($arRealEstate)); ?> <?=RealEstateSection::getItemTranslate('предложений',LANGUAGE_ID)?>
            </div>
            ...
            <ul class="data__categories data__categories_estate data__categories--property">
                <li class="data__categories-item ">
                    <a href="/<?=LANGUAGE_ID?>/nedvizhimost/kupit" class="data__categories-label">
                        ...
                        <div class="data__text"><?=RealEstateSection::getItemTranslate('Купить',LANGUAGE_ID)?></div>
                    </a>
                </li>
                ...
                <li class="data__categories-item">
                    <a href="/<?=LANGUAGE_ID?>/nedvizhimost/snyat" class="data__categories-label">
                        ...
                        <div class="data__text"><?=RealEstateSection::getItemTranslate('Снять',LANGUAGE_ID)?></div>
                    </a>
                </li>
                ...
                <li class="data__categories-item">
                    <a href="/<?=LANGUAGE_ID?>/nedvizhimost/posutochno" class="data__categories-label">
                        ...
                        <div class="data__text"><?=RealEstateSection::getItemTranslate('Посуточно',LANGUAGE_ID)?></div>
                    </a>
                </li>
                ...
                <li class="data__categories-item  data__categories-item--short">
                    <a href="/<?=LANGUAGE_ID?>/nedvizhimost/zapros-na-nedvizhimost" class="data__categories-label">
                        ...
                        <div class="data__text"><?=RealEstateSection::getItemTranslate('Запрос на недвижимость',LANGUAGE_ID)?></div>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <section class="map">
        ...
        <? $APPLICATION->IncludeComponent("nedvizhimost:nedvizhimost.map", ".default", array(), false); ?>
    </section>
                    ...
                    <ul class="form__items">
                        <li class="form__wrapper">
                            <div class="form__group">
                                <div class="form__group-select form-select">
            ...
            <div class="announcements__inner">
                    ...
                    <ul class="announcements__items">
                        <? foreach ($arRealEstate as $arItem): ?>
                            ...
                            <li class="announcements__item cart <? if (in_array($arItem['ID'], $resultFav)) {
                                ...
                                <a href="/<?=LANGUAGE_ID?>/nedvizhimost/<?= $url ?>/<?= $arItem['UF_SESSION_CODE'] ?>/">
                                    <div class="cart__top">
                                    ...
                                    <div class="cart__bottom">
                                        <div class="cart__wrapper">
                                            <div class="cart__left">
                                                <div class="cart__subtitle">
                                                    <?=RealEstateSection::getItemTranslate($arItem['UF_NAME'] ?? '',LANGUAGE_ID)?>
                                                </div>
                                            ...
                                            <div class="cart__right">
                                                <div class="cart__location">
                                                    <img class="cart__location-img"
                                                         ...
                                                         alt="местоположение">
                                                    <?=RealEstateSection::getItemTranslate($arItem['UF_ADDRESS']?? '',LANGUAGE_ID)?>
                                                </div>
                                        ...
                                        <div class="cart__info">
                                            <div class="cart__text">
                                                <?=RealEstateSection::getItemTranslate($arItem['UF_DESCRIPTION']?? '',LANGUAGE_ID)?>
                                            </div>
                                            ...
                                            <a class="cart__message btn-blue" href="#">
                                                <img class="cart__message-img"
                                                     ...
                                                     alt="Написать">
                                                <?=RealEstateSection::getItemTranslate('Написать',LANGUAGE_ID)?>

                                            </a>

                                            <a class="cart__favorite" data-item="<?= $arItem['ID'] ?>"
                                               data-razdel="2">
                                    ...
                                    <div class="cart__author">
                                        <div class="cart__name">
                                         <?=RealEstateSection::getItemTranslate($user['NAME'] ?? '',LANGUAGE_ID)?>
                                        </div>
                                        ...
                                        <div class="cart__tel">
                                            ...
                                            <div class="cart__tel-wrapper">
                                                ...
                                                <a class="cart__num" href="tel:<?= $user['PERSONAL_PHONE'] ?>">
                                                    <?= $user['PERSONAL_PHONE'] ?>
                                                </a>
                                            </div>
                                        </div>
                ...
                <form class="filter announcements__filter-properity filter-real_estate">
                    <div class="filter__title">
                        <?=RealEstateSection::getItemTranslate('Фильтр',LANGUAGE_ID)?>
                    </div>
                    ...
                    <ul class="filter__items">
                        <li class="filter__item">
                            <div class="info__select">
                                <input class="info__select-input" name="UF_DEAL_TYPE" readonly id="deal-type"
                                       placeholder="<?=RealEstateSection::getItemTranslate('Тип объявления',LANGUAGE_ID)?>"
                                       type="text"
                                       value="">
                        ...
                        <li class="filter__item disable-filter" id="filter__item_request">
                            <div class="info__select">
                                <input class="info__select-input" name="UF_REQUEST_FOR_PROPERTY" readonly
                                       id="request-property"
                                       placeholder="<?=RealEstateSection::getItemTranslate('Тип запроса на недвижимость',LANGUAGE_ID)?>"
                                       type="text">
                        ...
                        <li class="filter__item disable-filter" id="filter__item_type_of_rs">
                            <div class="info__select">
                                <input class="info__select-input" name="UF_TYPE_OF_RS" readonly id="type_of_rs"
                                       placeholder="<?=RealEstateSection::getItemTranslate('Вид недвижимости',LANGUAGE_ID)?>"
                                       type="text">
                        ...
                        <li class="filter__item disable-filter" id="filter__item_type">
                            <div class="info__select">
                                <input class="info__select-input" name="UF_TYPE" readonly
                                       placeholder="<?=RealEstateSection::getItemTranslate('Тип недвижимости',LANGUAGE_ID)?>"
                                       type="text">
                        ...
                        <li class="filter__item filter__item--range filter-price">
                            <div class="filter__subtitle"><?=RealEstateSection::getItemTranslate('Цена',LANGUAGE_ID)?></div>
                        ...
                        <li class="filter__item filter-sellers">
                            <div class="info__select">
                                ...
                                <ul class="info__list">
                                    <li class="info__box">
                                        <button class="info__elem"
                                                type="button"><?=RealEstateSection::getItemTranslate('Все',LANGUAGE_ID)?>
                                        </button>
                                    </li>
                    ...
                    <button class="filter__submit" type="submit" value="<?= $type_deal ?>">
                        Показать <span class="filter__submit-count"><? echo(count($arRealEstate)); ?></span>
                        объявлений
                    </button>
