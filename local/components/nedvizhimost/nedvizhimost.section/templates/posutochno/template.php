...
$UF_TYPE = RealEstateSection::getFieldEnumArr(273, [126, 127, 134, 129]);
...
<main class="main main--hidden  ">
    <section class="data">
        <div class="container">
            ...
            <ul class="data__categories data__categories_estate data__categories--property">
                ...
                <li class="data__categories-item data__categories-item--active">
    ...
    <section class="map">
        ...
        <div class="container">
            ...
            <a class="map__btn" href="/<?=LANGUAGE_ID?>/nedvizhimost/map.php?type_deal=71">Объявления на карте</a>
        </div>
    </section>
            ...
            <div class="announcements__inner">
                    ...
                    <ul class="announcements__items">
                        <? foreach ($arRealEstate as $arItem): ?>
                            <li class="announcements__item cart <? if (in_array($arItem['ID'], $resultFav)) {
                                ...
                                <a href="/<?=LANGUAGE_ID?>/nedvizhimost/posutochno/<?= $arItem['UF_SESSION_CODE'] ?>/">
                                    <div class="cart__top">
                ...
                <form class="filter announcements__filter-properity filter-real_estate">
                    ...
                    <ul class="filter__items">
                        ...
                        <li class="filter__item " id="filter__item_type">
                            <div class="info__select">
                    ...
                    <button class="filter__submit" type="submit" value="">
...
<script>
    ...
    const locations = [
        ...
        '<a href="/<?=LANGUAGE_ID?>/nedvizhimost/<?= $url ?>/<?= $item['UF_SESSION_CODE'] ?>/"><div class="map-block-item-cont">' +
