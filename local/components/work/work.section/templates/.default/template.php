<?php
use Work\Components\WorksSection;
use lib\GetUserData;

$arWorks = $arResult;

const MY_HL_BLOCK_ID_TYPES_WORKS = 10;
$entity_data_class_type_works = GetEntityDataClass(MY_HL_BLOCK_ID_TYPES_WORKS);
$rsData = $entity_data_class_type_works::getList(array());
...
const MY_HL_BLOCK_ID_FIELD_ACTIVITY = 29;
$entity_data_class_field_activity = GetEntityDataClass(MY_HL_BLOCK_ID_FIELD_ACTIVITY);
$rsData = $entity_data_class_field_activity::getList(array( "select" => array("*"),
    "order" => array("ID" => "ASC"),));
while ($el = $rsData->fetch()) {
    $fieldActivity[] = $el;
}

$arExp = WorksSection::getFieldEnum(158);
$arGrafic = WorksSection::getFieldEnum(157);
$arCandidat = WorksSection::getFieldEnum   (508);
...
<main class="main main--hidden">
    <section class="data data--services data--work">
        <div class="container">
            <div class="data__title title">
                <span class="data__title-categories">Работа</span>

                <img class="data__title-img" src="<?= SITE_TEMPLATE_PATH ?>/images/categories-swiper2.png"
                     alt="Недвижимость">
            ...
            <div class="data__offers">
                <?echo count($arWorks);?> предложений
            </div>

            <ul class="data__categories">
                <li class="data__categories-item data__categories-item--long fitted data__categories-item--active">
                    <a href="/<?=LANGUAGE_ID?>/rabota/" class="data__categories-label">
                        <img class="data__categories-img" src="<?= SITE_TEMPLATE_PATH ?>/images/data-work1.png"
                             alt="Купить">

                        <input class="data__radio" type="radio" name="categories" checked>

                        <div class="data__text">Вакансии</div>
                    </a>
                </li>

                <!--                    <li class="data__categories-item data__categories-item--long fitted">-->
                <!--                        <a href="/rabota/rezyume/" class="data__categories-label">-->
                <!--                            <img class="data__categories-img" src="--><?//= SITE_TEMPLATE_PATH ?><!--/images/data-work2.png"-->
                <!--                                 alt="Снять">-->
                <!---->
                <!--                            <input class="data__radio" type="radio" name="categories">-->
                <!---->
                <!--                            <div class="data__text">Резюме</div>-->
                <!--                        </a>-->
                <!--                    </li>-->
            </ul>
            <!--                --><?// $APPLICATION->IncludeComponent("work:work-variant", ".default", array(), false); ?>
            <a href="#" class="data__link-mob link">
    ...
    <section class="map">
        <? $APPLICATION->IncludeComponent("work:work.map", ".default", array(), false); ?>
    </section>
            ...
            <div class="announcements__top">
                ...
                <div class="announcements__filter">
                    <div class="announcements__select">
                        ...
                        <input class="select-input" type="text" id="work_select_date">
                    ...
                    <div class="announcements__select">
                        ...
                        <input class="select-input" type="text" id="work_select_price">
                        <ul class="announcements__select-list">
                            <li data-value="" class="announcements__select-list-item active">
                                По умолчанию
                            </li>
            ...
            <div class="announcements__inner">
                <div class="wrapper-filter" id="catalog">
                    <ul class="announcements__items">
                        <? foreach ($arWorks as $arItem): ?>

                            <li class="announcements__item cart <? if (in_array($arItem['ID'], $resultFav)) {
                                echo 'cart--favorite';
                            } ?>">
                                <a href="/<?=LANGUAGE_ID?>/rabota/<?= $arItem['UF_SESSION_CODE'] ?>/">
                                    <div class="cart__top">
                                    ...
                                    <div class="cart__bottom">
                                        ...
                                        <div class="cart__info">
                                            ...
                                            <a class="cart__favorite" data-item="<?= $arItem['ID'] ?>" data-razdel="3">
                ...
                <form class="filter announcements__filter-properity filter-work">
                    ...
                    <ul class="filter__items">
                        <li class="filter__item">
                            <div class="info__select">
                                <input class="info__select-input" name="UF_FIELDACTIVITY" readonly
                                ...
                                <ul class="info__list">
                                    ...
                                    <? foreach ($fieldActivity as $arIts): ?>
                                        <li class="info__box">
                                            <button class="info__elem"
                        ...
                        <li class="filter__item filter__item--range">
                            <div class="filter__wrapper">
                                <div class="filter__subtitle">График работы</div>
                                <? foreach ($arGrafic as $arIts): ?>
                                    <label class="filter__label">
                                        <input class="filter__checkbox" type="checkbox" name="grafic" value="<?= $arIts['ID'] ?>">
                        ...
                        <li class="filter__item">
                            <div class="info__select">
                                <input class="info__select-input" name="exp" readonly
                        ...
                        <li class="filter__item filter__item--range">
                            <div class="filter__wrapper">
                                <div class="filter__subtitle">Для кандидатов</div>
                                <? foreach ($arCandidat as $cand): ?>
                                    <label class="filter__label">
                                        <input class="filter__checkbox" type="checkbox" name="candidat" value="<?= $cand['ID'] ?>">
                        ...
                        <li class="filter__item">
                            <div class="filter__subtitle">Зарплата</div>
                    ...
                    <button class="filter__submit" type="submit">
                        Показать <span class="filter__submit-count"><? echo(count($arWorks)); ?></span> объявлений
                    </button>
