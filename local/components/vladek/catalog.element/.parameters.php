...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
		...
		"IBLOCK_TYPE" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("VLADEK_CATALOG_SECTION_COMPONENT_IBLOCK_TYPE"),
			"TYPE" => "LIST",
			"VALUES" => $arTypesEx,
			"DEFAULT" => "catalog",
			"REFRESH" => "Y",
		...
		"IBLOCK_ID" => array(
            "PARENT" => "BASE",
            "NAME" => GetMessage("VLADEK_CATALOG_SECTION_COMPONENT_IBLOCK_ID"),
            "TYPE" => "LIST",
            "VALUES" => $arIBlocks,
            "DEFAULT" => '',
            "ADDITIONAL_VALUES" => "Y",
        ...
        "ELEMENT_ID" => array(
            "PARENT" => "BASE",
            "NAME" => GetMessage("VLADEK_CATALOG_SECTION_COMPONENT_ELEMENT_ID"),
            "TYPE" => "LIST",
            "VALUES" => $arIBlocks,
            "DEFAULT" => '',
            "ADDITIONAL_VALUES" => "Y",
