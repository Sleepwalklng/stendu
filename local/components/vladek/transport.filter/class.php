...
/**
 * Class TransportMarkFilterComponent
 * @package Vladek\Components
 */
class TransportMarkFilterComponent extends CBitrixComponent
{
    private $section;
    ...
    public function getItems($iblockID, $marksID, $type = 'all', $mileage = 'all', $mark = 'all')
    {
        ...
        while($item = $items->fetch()){
            ...
            $marks = $entityDataClass::getList(array(
                'select' => array('ID', 'UF_TRANSPORT_MARK_CODE', 'UF_TRANSPORT_MARK_NAME', 'UF_TRANSPORT_MARK_LOGO'),
                'filter' => array('ID' => $item['UF_TRANSPORT_MARK'])
            ));
            $mark = $marks->fetch();
            $item['UF_TRANSPORT_MARK'] = $mark['UF_TRANSPORT_MARK_CODE'];
            $result['MARK_NAME'] = $mark['UF_TRANSPORT_MARK_NAME'];
            $result['MARK_BANNER'] = $mark['UF_TRANSPORT_MARK_LOGO'];
