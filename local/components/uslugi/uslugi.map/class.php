 ...
 */
class UslugiMainMapComponent extends CBitrixComponent
{
    ...
    public function executeComponent()
    {
        ...
        $this->arResult['MAP'] = $this->getMap(1);
    ...
    public function getMap($iblockID){
        ...
        $rsUslugi = $entity_data_class_uslugi::getList(array( "select" => array("*"), "order" => array("ID" => "DESC"),
