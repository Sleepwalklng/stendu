<?php
use Uslugi\Components\UslugiSection;
use lib\GetUserData;
        ...
        <div class="container">
            ...
            <div class="data__wrapper">
                <div class="categories__prev">
                    <img class="categories__arrow" src="<?= SITE_TEMPLATE_PATH ?>/images/arrow-black.svg"
                         alt="предыдущая категория">
                </div>

                <div class="data__inner">
                    <ul class="data__categories data__categories--services swiper-wrapper">

                        <? foreach ($arTypes as $arIt): ?>

                            <? if (!empty($arIt['UF_NAME'])): ?>
                                <? $img_path = CFile::GetPath($arIt["UF_PHOTO"]);
                                ?>
                                <li class="data__categories-item categories--service swiper-slide ">
                                    <a class="data__categories-label  uslugi_filter-category"
                                       data-id="<?= $arIt["UF_NAME"] ?>">
                                        <img class="data__categories-img" src="<?= $img_path ?>" alt="">

                                        <input class="data__radio" type="radio" name="categoryID" checked>
    ...
    <section class="announcements announcements--services">
        <div class="container">
            <div class="announcements__top">
                ...
                <div class="announcements__filter">
                    <div class="announcements__select">
                        ...
                        <input class="select-input" type="text" id="uslugi_select_date">
                    ...
                    <div class="announcements__select">
                        ...
                        <input class="select-input" type="text" id="uslugi_select_price">
                        <ul class="announcements__select-list">
                            <li data-value="" class="announcements__select-list-item active">
                                По умолчанию
                            </li>
                ...
                <label class="announcements__format announcements__format--active">
                    <input class="announcements__radio" id="format_tile" name="format" type="radio">
                ...
                <label class="announcements__format announcements__format--justify" id="format-carts">
                    <input class="announcements__radio" value="off" id="format_string" name="format" type="radio">
            ...
            <div class="announcements__inner">
                ...
                <div id="catalog" class="wrapper-filter">
                        ...
                        <? foreach ($arUslugi as $arItem): ?>
                            ...
                            <? if (!empty($arItem['UF_NAME'])): ?>
                                <li class="announcements__item cart <? if (in_array($arItem['ID'], $resultFav)) {
                                    ...
                                    <a href="/<?=LANGUAGE_ID?>/uslugi/<?= $url ?>/<?= $arItem['UF_SESSION_CODE'] ?>/">
                                        <div class="cart__top">
                    ...
                    <ul class="filter__items">
                        <li class="filter__item">
                            ...
                            <div class="info__select">
                                <input class="info__select-input" name="categoria" readonly placeholder="Услуги"
                                       type="text">

                                <ul class="info__list">
                                    <? foreach ($arTypes as $arIts): ?>
                        ...
                        <!---->
                        <!--                                <div class="info__select">-->
                        <!--                                    <input class="info__select-input" name="address" readonly placeholder="Регион"-->
                        <!--                                           type="text">-->
                        <!---->
                        <!--                                    <ul class="info__list">-->
                        <!--                                       <li class="info__box">-->
                        <!--                                           <button class="info__elem"-->
                        <!--                                                   type="button">Рига</button>-->
                        <!--                                       </li>-->
                        <!--                                </div>-->
                        <!---->
                        <!--                            </li>-->
                        ...
                        <!--                                            <input class="filter__radio" name="apartment" type="radio" value="9">-->
                        <!---->
                        <!--                                            Частные-->
                        <!--                                        </label>-->
                        <!--                                    </li>-->
                        ...
                        <!--                                    <li class="filter__case">-->
                        <!--                                        <label class="filter__label-radio">-->
                        <!--                                            <input class="filter__radio" name="apartment" type="radio" value="10">-->
                        <!---->
                        <!--                                            Компании-->
                        <!--                                        </label>-->
                        <!--                                    </li>-->
