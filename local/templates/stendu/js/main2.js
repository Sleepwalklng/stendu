...
$('.map-filter__close').on('click', function (e) {
  // $('body').removeClass('body--active');
...
$('.modal-login-open').on('click', function (e) {
  //$('.modal-login').addClass('body--active');
  ...
  if ($(e.target).hasClass('announcements__elem')) {
    ...
    if (!$(this).hasClass('announcements__select--active')) {
      $('.announcements__select')
        .removeClass('announcements__select--active')
        .children('.announcements__list')
        .css('display', 'none');
...
$('.announcements__elem').on('click', function () {
  $(this).val();
  $(this)
    .closest('.announcements__select')
    .removeClass('announcements__select--active')
    .children('.announcements__list')
    .css('display', 'none');
  $(this)
    .closest('.announcements__select')
    .find('.announcements__select-text')
    .text($(this).text());
});
...
$('.data__categories .data__radio').on('change', function () {
  $('.data__categories .data__radio')
    .closest('.data__categories-item')
    .removeClass('data__categories-item--active');
  $(this).closest('.data__categories-item').addClass('data__categories-item--active');
});

$('.data__isuse .data__radio').on('change', function () {
  $('.data__isuse .data__radio')
    .closest('.data__isuse-label')
    .removeClass('data__isuse-label--active');
...
if ($('.polzunok').html() != null) {
  $('.polzunok').slider({
    ...
    slide: function (event, ui) {
      ...
      $('.polzunok-input-left').trigger('change');
      $('.polzunok-input-right').trigger('change');
    },
  });
  $('.polzunok-input-left').val($('.polzunok').slider('values', 0));
  $('.polzunok-input-right').val($('.polzunok').slider('values', 1));
  $('.polzunok-container input').on('change', function () {
