...
$rsUsers = CUser::GetList(array($by = "ID"), array($order = "ASC"), $filter, $arParameters);
...
function getListHL($userId, $HLID): array
{
    $arr =[];
...
{
    $arLichnue = getListHL($userId, MY_HL_BLOCK_ID_LICH);
    $arUslugi = getListHL($userId, MY_HL_BLOCK_ID_USLUGI);
    $arNedv = getListHL($userId, MY_HL_BLOCK_ID_NEDVIZHIMOST);
    $arWorks = getListHL($userId, MY_HL_BLOCK_ID_WORK);
    $arResume = getListHL($userId, MY_HL_BLOCK_ID_RESUME);

    $arAdvert = array_merge($arLichnue, $arUslugi, $arNedv, $arWorks, $arResume);
    return $arAdvert;
}
$arAdvert = getUserAdvert($ID_user);
$arAnnouncement = [];
$arAnnouncement['ACTIVE'] = [];
$arAnnouncement['INACTIVE'] = [];
$arAnnouncement['MODERATION'] = [];
$arAnnouncement['REJECTED'] = [];
$arAnnouncement['DRAFT'] = [];
foreach ($arAdvert as $key => $item) {
    if ($item['UF_STATUS'] == 84 || $item['UF_STATUS'] == 29 || $item['UF_STATUS'] == 24 || $item['UF_STATUS'] == 49 || $item['UF_STATUS'] == 34) {
        $item['status'] = 'ACTIVE';
        $arAnnouncement['ACTIVE'][$key] = $item;
    } else if ($item['UF_STATUS'] == 85 || $item['UF_STATUS'] == 30 || $item['UF_STATUS'] == 25 || $item['UF_STATUS'] == 50 || $item['UF_STATUS'] == 35) {
        $item['status'] = 'INACTIVE';
        $arAnnouncement['INACTIVE'][$key] = $item;
    } else if ($item['UF_STATUS'] == 86 || $item['UF_STATUS'] == 31 || $item['UF_STATUS'] == 26 || $item['UF_STATUS'] == 51 || $item['UF_STATUS'] == 36) {
        $item['status'] = 'MODERATION';
        $arAnnouncement['MODERATION'][$key] = $item;
    } else if ($item['UF_STATUS'] == 87 || $item['UF_STATUS'] == 32 || $item['UF_STATUS'] == 27 || $item['UF_STATUS'] == 52 || $item['UF_STATUS'] == 37) {
        $item['status'] = 'REJECTED';
        $arAnnouncement['REJECTED'][$key] = $item;
    } else if ($item['UF_STATUS'] == 88 || $item['UF_STATUS'] == 33 || $item['UF_STATUS'] == 28 || $item['UF_STATUS'] == 53 || $item['UF_STATUS'] == 38) {
        $item['status'] = 'DRAFT';
        $arAnnouncement['DRAFT'][$key] = $item;
    }
}

/*foreach ($arAdvert as $i => $adv) {
  $arAdvert[$i]['advDate'] = date_create_from_format('d.m.Н H:i:s', $adv['UF_DATA'])/*->getTimestamp();
}
usort($arAdvert, function($a,$b){
    return ($b['advDate'] - $a['advDate']);
});*/


$allCount = count($arAdvert);
    ...
    <main class="main">
        ...
        <section class="admin-st">
            <div class="container">
                ...
                <span class="js-size">
                  ...
                  <div class="text">Мои объявления</div>
                                ...
                                <ul class="admin-st__sidebar-list">
                                    ...
                                    <li class="admin-st__sidebar-item sidebar-item-js active-item-js">
                                        <!-- sidebar-item-js -->
                                    ...
                                    <li class="admin-st__sidebar-item"><!-- sidebar-item-js -->
                                        <a href="/profile/uvedomleniya" class="admin-st__link">
                                            ...
                                            <span class="admin-st__diebar-toast">2</span>
                                        </a>
                                    </li>
                                    <!-- /.admin-st__sidebar-item -->
                                    <li class="admin-st__sidebar-item"><!-- sidebar-item-js -->
                    ...
                    <div class="admin-st__right">
                        ...
                        <div class="admin-st__right-block global-block-js"><!-- global-block-js -->
                            <div class="admin-st__advertisement">
                                <div class="admin-st__title">
                                    Мои объявления
                                </div>
                                <!-- title -->
                                <ul class="admin-st__advertisement-menu">
                                    <li class="admin-st__advertisement-item js-tab-item">
                                        <span>Все</span><span class="number"><?= $allCount ?></span>
                                    </li>
                                    <!-- li -->
                                    <li class="admin-st__advertisement-item js-tab-item">
                                        <span>Активные</span><span
                                                class="number"><?= count($arAnnouncement['ACTIVE']) ?></span>
                                    </li>
                                    <!-- li -->
                                    <li class="admin-st__advertisement-item js-tab-item">
                                        <span>Неактивные</span><span
                                                class="number"><?= count($arAnnouncement['INACTIVE']) ?></span>
                                    </li>
                                    <!-- li -->
                                    <li class="admin-st__advertisement-item js-tab-item">
                                        <span>Модерация</span><span
                                                class="number"><?= count($arAnnouncement['MODERATION']) ?></span>
                                    </li>
                                    <!-- li -->
                                    <li class="admin-st__advertisement-item js-tab-item">
                                        <span>Отклоненные</span><span
                                                class="number"><?= count($arAnnouncement['REJECTED']) ?></span>
                                    </li>
                                    <!-- li -->
                                    <li class="admin-st__advertisement-item js-tab-item">
                                        <span>Черновики</span><span
                                                class="number"><?= count($arAnnouncement['DRAFT']) ?></span>
                                    </li>
                                    <!-- li -->
                                </ul>
                                <!-- advertisement-menu -->
                                <div class="admin-st__advertisement-content advertisement-content-js">
                                    <!-- advertisement-content-js -->
                                    <div class="admin-st__not-block">
                                    ...
                                    <? foreach ($arAdvert as $item) { ?>
                                        <article class="admin-st__card">
                                            <div class="admin-st__card-left">
                                                <div class="admin-st__card-image">
                                                    <img src="<?= CFile::GetPath($item['UF_PHOTOS']['0']) ?>" alt="дом">
                                                </div>
                                                <!-- image -->
                                                <div class="admin-st__card-table">
                                                    <div class="admin-st__card-table-icon">
                                                        <progress class="card-progress" max="30" value="27"></progress>
                                                    </div>
                                                    <!-- icon -->
                                                    <div class="admin-st__card-table-text">
                                                        <span class="number">30</span> <span class="day">дней</span>
                                                    </div>
                                                    <!-- /.admin-st__card-table-text -->
                                                </div>
                                                <!-- table -->
                                            </div>
                                            <!-- left -->
                                            <div class="admin-st__card-right line-p">
                                                <div class="admin-st__card-info">
                                                    ...
                                                    <div class="admin-st__card-info-price">
                                                        <?= number_format($item['UF_PRICE'], 0, '.', ' ') ?>
                                                        <span>€</span>
                                                    </div>
                                                    <!-- price -->
                                                </div>
                                                <!-- info -->
                                                <div class="admin-st__card-statistics">
                                                    <div class="admin-st__card-statistics-title">
                                                        Статистика
                                                    </div>
                                                    <!-- title -->
                                                    <div class="admin-st__card-statistics-people">
                                                        <div class="admin-st__card-statistics-people-icon">
                                                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/stat/user.svg"
                                                                 alt="люди">
                                                        </div>
                                                        <!-- icon -->
                                                        <div class="admin-st__card-statistics-people-numbers">
                                                            230
                                                        </div>
                                                        <!-- numbers -->
                                                    </div>
                                                    <!-- /.admin-st__card-statistics-people -->
                                                    <div class="admin-st__card-statistics-views">
                                                        <div class="admin-st__card-statistics-views-icon">
                                                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/stat/eye.svg"
                                                                 alt="глаз">
                                                        </div>
                                                        <!-- icon -->
                                                        <div class="admin-st__card-statistics-views-numbers">
                                                            6 000
                                                        </div>
                                                        <!-- numbers -->
                                                    </div>
                                                    <!-- views -->
                                                    <div class="admin-st__card-statistics-heart">
                                                        <div class="admin-st__card-statistics-heart-icon">
                                                            <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/stat/heart.svg"
                                                                 alt="сердце">
                                                        </div>
                                                        <!-- icon -->
                                                        <div class="admin-st__card-statistics-heart-numbers">
                                                            45
                                                        </div>
                                                        <!-- numbers -->
                                                    </div>
                                                ...
                                                <!-- statistics -->
                                                <div class="admin-st__card-btns">
                                                    <button class="admin-st__card-btns-tik"></button>
                                                    <button class="admin-btn admin-btn--edit-blue"
                                                            data-id="<?= $item['ID'] ?>"
                                                            data-hl_id="<?= $item['HL'] ?>"
                                                            data-name="<?= $item['UF_NAME'] ?>"
                                                        <? if ($item['HL'] == 2) { ?>
                                                            data-type="<?= $item['UF_TYPE'] ?>"
                                                            data-deal="<?= $item['UF_DEAL_TYPE'] ?>"
                                                            data-request="<?= $item['UF_REQUEST_FOR_PROPERTY'] ?>"
                                                            data-type_of_rs="<?= $item['UF_TYPE_OF_RS'] ?>"
                                                            data-agent="<?= $item['UF_SELLERS'] ?>"
                                                        <? } elseif ($item['HL'] == 1) { ?>
                                                            data-type="<?= $item['UF_TYPE_USLUGI'] ?>"
                                                        <? } elseif ($item['HL'] == 11) { ?>
                                                            data-type="<?= $item['UF_FIELDACTIVITY'] ?>"
                                                        <? } elseif ($item['HL'] == 13) { ?>
                                                            data-cat="<?= $item['UF_CATEGORY'] ?>"
                                                            data-subcat="<?= $item['UF_CATEGORIES_OUTERWEAR'] ?>"
                                                            data-type="<?= $item['UF_TYPE'] ?>"
                                                        <? } ?>
                                                    >
                                                        <span>Редактировать</span>
                                                    </button>
                                                    <button class="admin-btn admin-btn--views">
                                                        <span>Поднять просмотры</span>
                                                    </button>
                                                </div>
                                                <!-- btns -->
                                            </div>
                ...
                <article class="admin-st__card">
                  <div class="admin-st__card-left">
                    ...
                    <div class="admin-st__card-table">
                      <div class="admin-st__card-table-icon">
                        <progress class="card-progress" max="30" value="20"></progress>
                      </div>
                      <!-- icon -->
                      <div class="admin-st__card-table-text">
                        <span class="number">28</span> <span class="day">дней</span>
                      </div>
                      <!-- /.admin-st__card-table-text -->
                    </div>
                    <!-- table -->
                  ...
                  <div class="admin-st__card-right">
                    ...
                    <div class="admin-st__card-statistics">
                      ...
                      <div class="admin-st__card-statistics-people">
                        <div class="admin-st__card-statistics-people-icon">
                          <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/stat/user.svg" alt="люди">
                        </div>
                        <!-- icon -->
                        <div class="admin-st__card-statistics-people-numbers">
                          230
                      ...
                      <div class="admin-st__card-statistics-views">
                        <div class="admin-st__card-statistics-views-icon">
                          <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/stat/eye.svg" alt="глаз">
                        </div>
                        <!-- icon -->
                        <div class="admin-st__card-statistics-views-numbers">
                          6 000
                      ...
                      <div class="admin-st__card-statistics-heart">
                        <div class="admin-st__card-statistics-heart-icon">
                          <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/stat/heart.svg" alt="сердце">
                        </div>
                        <!-- icon -->
                        <div class="admin-st__card-statistics-heart-numbers">
                          45
                ...
                <article class="admin-st__card">
                  <div class="admin-st__card-left">
                    ...
                    <!-- image -->
                    <div class="admin-st__card-table admin-st__card-table--grey">
                      <div class="admin-st__card-table-text ">
                        <div class="table-text">Модерация</div>
                      </div>
                      <!-- /.admin-st__card-table-text -->
                    </div>
                    <!-- table -->
                ...
                <article class="admin-st__card">
                  <div class="admin-st__card-left">
                    ...
                    <!-- image -->
                    <div class="admin-st__card-table admin-st__card-table--expired">
                      <div class="admin-st__card-table-text ">
                        <div class="table-text">Истек срок</div>
                      </div>
                      <!-- /.admin-st__card-table-text -->
                    </div>
                    <!-- table -->
                  ...
                  <div class="admin-st__card-right">
                    ...
                    <div class="admin-st__card-btns">
                      ...
                      <button class="admin-btn admin-btn--expired">
          ...
          */ ?>
                                ...
                                <!-- content -->
                                <? foreach ($arAnnouncement as $key => $status) { ?>
                                    <div class="admin-st__advertisement-content advertisement-content-js">
                                            ...
                                            if ($item['status'] == $key) {
                                                ...
                                                <article class="admin-st__card">
                                                    <div class="admin-st__card-left">
                                                        ...
                                                        <!-- image -->
                                                        <div class="admin-st__card-table admin-st__card-table--draft">

                                                            <div class="admin-st__card-table-text">
                                                                <span class="text">Черновик</span>
                                                            </div>
                                                            <!-- /.admin-st__card-table-text -->
                                                        </div>
                                                        <!-- table -->
                                                    ...
                                                    <div class="admin-st__card-right">
                                                        ...
                                                        <div class="admin-st__card-btns">
                                                            <button class="admin-st__card-btns-tik"></button>
                                                            <button class="admin-btn admin-btn--edit-blue admin-btn--edit-bluу-big "
                                                                    data-id="<?= $item['ID'] ?>"
                                                                    data-hl_id="<?= $item['HL'] ?>"
                                                                    data-name="<?= $item['UF_NAME'] ?>"
                                                                <? if ($item['HL'] == 2) { ?>
                                                            ...
                                                            <? if ($item['UF_STATUS'] == 88) { ?>
                                                                <button data-id="<?= $item['ID'] ?>"
                                                                        class="admin-btn publish-btn admin-btn--active">
                                                                    <span>Опубликовать</span>
                                                                </button>
                                                            <? } else { ?>
                                                                <button class="admin-btn admin-btn--views">
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.admin-btn--edit-blue').click(function () {
                    let that = $(this);
                    var id = that.attr('data-id');
                    var name = that.attr('data-name');
                    var hl_id = that.attr('data-hl_id');
                    if (hl_id == 2) {
                        var region = 54;
                        var agent = that.attr('data-agent');
                        var deal = that.attr('data-deal');
                        var type = that.attr('data-type');
                        var request = that.attr('data-request');
                        var type_of_rs = that.attr('data-type_of_rs');
                        if (deal) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                name: name,
                                hl_id: hl_id,
                                category: 'Услуги', subcategory: 'Производство',subcategoryID:type
                            },
                            dataType: 'html',
                            success: function (e) {
                                $('.main').empty().append(e);
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                name: name,
                                hl_id: hl_id,
                                category: 'Работа', subcategory: 'Производство',subcategoryID:type
                            },
                            dataType: 'html',
                            success: function (e) {
                                $('.main').append(e);
                        ...
                        var type = that.attr('data-type');
                        var cat = that.attr('data-cat');
                        var subcat = that.attr('data-subcat');
                        $.ajax({
                            type: 'post',
                            url: '/ajax/category/three-step.php',
                            data: {
                                ...
                                name: name,
                                hl_id: hl_id,
                                category: 'Личные вещи', subcategory: 'Производство',subcategoryNum22:cat,subcategoryNum33:type,subcategoryNum4:subcat
                            },
                            dataType: 'html',
                            success: function (e) {
                                $('.main').append(e);
