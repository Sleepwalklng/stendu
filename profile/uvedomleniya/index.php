            ...
            <div class="admin-st__wrapper">
                ...
                <div class="admin-st__right">
                    ...
                    <div class="admin-st__right-block global-block-js">
                        ...
                        <!-- /.admin-st__title -->
                        <div class="admin-st__notifications">
                            <? foreach (array_reverse($arUser['UF_NOTICE'], true) as $notice):
                                $notice = explode('<product>', $notice); ?>
                                <div class="admin-st__notifications-card">
                                    <div class="admin-st__notifications-card-icon">
                                        <img src="<?= SITE_TEMPLATE_PATH ?>/img/admin-st/icon/warning-2.svg" alt="">
                                    </div>
                                    <!-- /.admin-st__notifications-card-icon -->
                                    <div class="admin-st__notifications-card-block">
                                        <div class="admin-st__notifications-card-text"><?= $notice[0] ?>
                                        </div>
                                        <div class="admin-st__notifications-card-product"><?= $notice[1] ?>
                                        </div>
                                    </div>
                                    <!-- /.admin-st__notifications-card-block -->
                                    <div class="admin-st__notifications-card-date">
                                        20.12.2021
                                    </div>
                                    <!-- /.admin-st__notifications-card-date -->
                                </div>
                                <!-- /.admin-st__notifications-block -->
                            <? endforeach; ?>
                        </div>
                        <!-- /.admin-st__notifications -->
                    </div>
