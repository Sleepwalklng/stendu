...
include_once $_SERVER["DOCUMENT_ROOT"]."/my-app/vendor/autoload.php";
...
define ("API_KEY", "jaroslavst@mail.rube8222cfd90a0442dd4c4400f9e94908");
define ("API_URL", "https://api.basebuy.ru/api/auto/v1/");
$downloadFolder = $_SERVER['DOCUMENT_ROOT'].'/';

$lastDateUpdate = strtotime('01.01.2016 00:00:00');
